# ADR 0010: Discover and activate tools within the current response

Status: Implemented.

## Problem

Client-held tool lists go stale, and loading every schema on every turn is wasteful. Capability discovery must stay separate from capability authority.
