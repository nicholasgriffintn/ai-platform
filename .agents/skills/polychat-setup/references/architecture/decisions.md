...
- [0043](decisions/0043-version-lossless-chat-input-rewriting.md): Enable lossless chat input rewriting by default, with scope-owned overrides and revision history.
