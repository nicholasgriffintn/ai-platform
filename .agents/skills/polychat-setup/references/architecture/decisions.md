...
- [0080: Run workspace tasks through Vite+](decisions/0080-run-workspace-tasks-through-vite-plus.md).
...
Keep surviving record numbers stable; gaps are intentional. Records 0003 and 0004 were previously folded into 0005, now 0029. The retired 0014 package proposal is covered by 0001. Do not reuse retired numbers; the next new decision is 0081.
