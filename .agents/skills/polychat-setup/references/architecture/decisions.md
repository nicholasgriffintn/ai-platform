...
- [0041](decisions/0041-usage-metering-and-credits.md): Meter work in vendor units and bill it in credits, with a write-once ledger, additive balances, and rates derived from the model catalogue.
