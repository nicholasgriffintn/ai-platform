...
- [ ] In the "By provider" filter and section headings, confirm Google AI Studio, Perplexity AI, The Grid AI, Standard Compute, Azure OpenAI and GitHub Models show artwork rather than an initial.
