...
- [ ] Both scopes [ ] Files [ ] Tool [ ] Reach [ ] Task [ ] Shell [ ] Catalogue [ ] iOS [ ] Tests
...
- [ ] Personal only, with the reason shown [ ] Files [ ] Tool, or a stated reason it has none [ ] Reach [ ] Task [ ] Shell [ ] Catalogue [ ] iOS [ ] Tests
