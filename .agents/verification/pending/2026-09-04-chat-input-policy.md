...
- [ ] In Profile customisation, select Compact JSON whitespace. Preview formatted JSON and confirm string whitespace remains intact while formatting whitespace disappears. Saving the preview alone must not change the policy.
