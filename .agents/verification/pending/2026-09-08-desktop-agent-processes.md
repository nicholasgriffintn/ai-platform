...
- **Risk if wrong:** an agent runs outside the granted directory, or a signed-out CLI looks available and fails opaquely mid-run.
- **Commits:** `fef6f4377`, `1af4a497a`, `2b3a4b836`, `7afe82501`, `ca703d263`, `2db03b095`, `4801080e4`.

## Verify

- [ ] Grant a workspace directory through the picker and confirm the agent runs inside it and cannot reach a path outside the grant.
...
**Stop and report if:** an agent reaches outside its granted directory, or a signed-out or missing CLI is offered as ready.

_Reviewing and committing an external agent's edits is covered by [Antigravity launches only from an approved workspace](2026-09-08-antigravity-review.md) and [Run review evidence fences local commits](2026-09-08-review-and-local-commit.md)._
