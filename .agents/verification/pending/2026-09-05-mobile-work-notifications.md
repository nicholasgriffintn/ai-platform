...
- **Prerequisites:** apply migration `0024_mobile_push_devices.sql`; configure `APNS_KEY_ID`, `APNS_TEAM_ID`, `APNS_PRIVATE_KEY` and `APNS_TOPIC`; enable Push Notifications for the signed iOS application identifier.
