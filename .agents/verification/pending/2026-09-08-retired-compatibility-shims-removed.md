...
- [ ] Open `/profile` and switch through every tab, confirming each resolves and none 404s.
...
- [ ] Open an output revision created before provenance was captured and confirm it reads as an unknown, partial record rather than erroring.
