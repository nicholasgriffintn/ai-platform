...
export type LogoVariant = "logo_control" | "logo_minimalist" | "logo_tropical" | "logo_abstract";
...
const LOGO_BY_VARIANT: Record<LogoVariant, string> = {
  logo_control: defaultParrot,
  logo_minimalist: minimalistParrot,
  logo_tropical: tropicalParrot,
  logo_abstract: abstractParrot,
};

export function LogoMark({ variant = "logo_control", className = "" }: LogoMarkProps) {
  return (
    <div
      className={className}
      dangerouslySetInnerHTML={{ __html: LOGO_BY_VARIANT[variant] ?? defaultParrot }}
      role="img"
