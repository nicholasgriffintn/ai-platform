...
class ApiService {
  ...
  submitFeedback = (completion_id: string, message_id: string, feedback: 1 | -1): Promise<void> => {
    return this.chatService.submitFeedback(completion_id, message_id, feedback);
  };
