...
import { convertMarkdownToHtml } from "@ngriffin_uk/polychat-utility-server/markdown";
...
export interface OcrApiBlockConfidenceScores {
...
export interface OcrApiBlock {
  ...
  content: string;
  confidence_scores?: OcrApiBlockConfidenceScores | null;
  image_id?: string;
...
function normaliseTable(table: OcrApiTable) {
