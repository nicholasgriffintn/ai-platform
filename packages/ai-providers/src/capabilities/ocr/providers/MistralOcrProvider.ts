...
export class MistralOcrProvider implements OcrProvider {
  ...
  async extractText(request: OcrExtractionRequest): Promise<OcrExtractionResult> {
    try {
      ...
      const modelConfig = await this.runtime.host.models.resolveModelConfig(
