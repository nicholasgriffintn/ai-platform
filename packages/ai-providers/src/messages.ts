...
import type { CreateChatCompletionsResponse, Message, MessageContent } from "./types/index.js";
...
export function requireMessages(params: { messages?: Message[] }): Message[] {
  if (!params.messages?.length) {
    throw new AssistantError("Missing messages", ErrorType.PARAMS_ERROR);
  }
