...
import { builtInSkillDocumentSources } from "./generated/documents.js";
import { parseSkillDocument, parseUserSkillDocument, validateSkillResourcePath } from "./schema.js";
import {
  toSkillDefinition,
  toSkillSummary,
  type SkillContent,
...
export interface SkillRuntimeAuthorisation {
  scopeId: string;
  skillId: string;
}
...
export interface SkillRuntime {
  ...
  authorisation: SkillRuntimeAuthorisation;
}
