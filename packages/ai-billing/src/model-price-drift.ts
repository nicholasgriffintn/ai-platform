import { normaliseModelIdentifier } from "@ngriffin_uk/polychat-ai-models";
...
function buildReferenceIndex(
  references: readonly ModelPriceReference[],
): Map<string, ModelPriceReference> {
  const index = new Map<string, ModelPriceReference>();
