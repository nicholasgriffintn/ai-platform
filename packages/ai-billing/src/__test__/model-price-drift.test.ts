...
import { detectModelPriceDrift, type ModelPriceReference } from "../model-price-drift.js";

function makeReference(overrides: Partial<ModelPriceReference> = {}): ModelPriceReference {
  return {
    id: "aa-1",
