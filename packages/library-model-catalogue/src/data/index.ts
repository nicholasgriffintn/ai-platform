...
import family171 from "./families/openrouter~2Faion-labs~2Faion-1.0.json" with { type: "json" };
...
import family174 from "./families/openrouter~2Faion-labs~2Faion-3.0.json" with { type: "json" };
...
import family187 from "./families/openrouter~2Fbaidu~2Fernie-4.5-21b-a3b.json" with { type: "json" };
...
import family215 from "./families/openrouter~2Frelace~2Frelace-apply-3.json" with { type: "json" };
import family216 from "./families/openrouter~2Frelace~2Frelace-search.json" with { type: "json" };
import family217 from "./families/openrouter~2Fsao10k~2Fl3-euryale-70b.json" with { type: "json" };
import family218 from "./families/openrouter~2Fsarvamai~2Fsarvam-m~3Afree.json" with { type: "json" };
import family219 from "./families/openrouter~2Fsourceful~2Friverflow-v2-fast-preview.json" with { type: "json" };
import family220 from "./families/openrouter~2Fsourceful~2Friverflow-v2-max-preview.json" with { type: "json" };
import family221 from "./families/openrouter~2Fsourceful~2Friverflow-v2-standard-preview.json" with { type: "json" };
import family222 from "./families/openrouter~2Fstepfun~2Fstep-3.5-flash.json" with { type: "json" };
import family223 from "./families/openrouter~2Fstepfun~2Fstep-3.5-flash~3Afree.json" with { type: "json" };
import family224 from "./families/openrouter~2Fstepfun~2Fstep-3.7-flash.json" with { type: "json" };
import family225 from "./families/openrouter~2Fswitchpoint~2Frouter.json" with { type: "json" };
import family226 from "./families/openrouter~2Fthedrummer~2Fcydonia-24b-v4.1.json" with { type: "json" };
import family227 from "./families/openrouter~2Fthedrummer~2Frocinante-12b.json" with { type: "json" };
import family228 from "./families/openrouter~2Fthedrummer~2Fskyfall-36b-v2.json" with { type: "json" };
import family229 from "./families/openrouter~2Fthedrummer~2Funslopnemo-12b.json" with { type: "json" };
import family230 from "./families/openrouter~2Ftngtech~2Ftng-r1t-chimera~3Afree.json" with { type: "json" };
import family231 from "./families/openrouter~2Fundi95~2Fremm-slerp-l2-13b.json" with { type: "json" };
import family232 from "./families/openrouter~2Fxiaomi~2Fmimo-v2-flash.json" with { type: "json" };
import family233 from "./families/openrouter~2Fxiaomi~2Fmimo-v2-omni.json" with { type: "json" };
import family234 from "./families/openrouter~2Fxiaomi~2Fmimo-v2-pro.json" with { type: "json" };
import family235 from "./families/osmosis.json" with { type: "json" };
import family236 from "./families/palmyra.json" with { type: "json" };
import family237 from "./families/parallel~2Fspeed.json" with { type: "json" };
import family238 from "./families/perplexity-ai~2Fr1-1776.json" with { type: "json" };
import family239 from "./families/perplexity-ai~2Fsonar-deep-research.json" with { type: "json" };
import family240 from "./families/perplexity-ai~2Fsonar-reasoning.json" with { type: "json" };
import family241 from "./families/phi.json" with { type: "json" };
import family242 from "./families/pixtral.json" with { type: "json" };
import family243 from "./families/qvq.json" with { type: "json" };
import family244 from "./families/qwen.json" with { type: "json" };
import family245 from "./families/qwen3.5.json" with { type: "json" };
import family246 from "./families/qwen3.6.json" with { type: "json" };
import family247 from "./families/qwen3.7-max.json" with { type: "json" };
import family248 from "./families/qwen3.7-plus.json" with { type: "json" };
import family249 from "./families/qwen3.8-max.json" with { type: "json" };
import family250 from "./families/recraft.json" with { type: "json" };
import family251 from "./families/rednote.json" with { type: "json" };
import family252 from "./families/regolo-ai~2Fapertus-70b.json" with { type: "json" };
import family253 from "./families/regolo-ai~2Fbrick-complexity-pro.json" with { type: "json" };
import family254 from "./families/reka.json" with { type: "json" };
import family256 from "./families/replicate~2F671ac645ce5e552cc63a54a2bbff63fcf798043055d2dac5fc9e36a837eedcfb.json" with { type: "json" };
import family258 from "./families/replicate~2F847dfa8b01e739637fc76f480ede0c1d76408e1d694b830b5dfb8e547bf98405.json" with { type: "json" };
import family255 from "./families/replicate~2F5599ed30703defd1d160a25a63321b4dec97101d98b4674bcc56e41f62f35637.json" with { type: "json" };
import family257 from "./families/replicate~2F826801120720e563620006b99e412f7ed7b991dd4477e9160473d44a405ef9d9.json" with { type: "json" };
import family259 from "./families/replicate~2Falibaba~2Fhappyhorse-1.0.json" with { type: "json" };
import family260 from "./families/replicate~2Fbria~2Fremove-background.json" with { type: "json" };
import family261 from "./families/replicate~2Fcbd15da9f839c5f932742f86ce7def3a03c22e2b4171d42823e83e314547003f.json" with { type: "json" };
import family262 from "./families/replicate~2Felevenlabs~2Fmusic.json" with { type: "json" };
import family264 from "./families/replicate~2Fgoogle~2Fnano-banana-2.json" with { type: "json" };
import family265 from "./families/replicate~2Fgoogle~2Fnano-banana-pro.json" with { type: "json" };
import family263 from "./families/replicate~2Fgoogle~2Fnano-banana.json" with { type: "json" };
import family266 from "./families/replicate~2Fnightmareai~2Freal-esrgan.json" with { type: "json" };
import family267 from "./families/replicate~2Fprunaai~2Fp-video.json" with { type: "json" };
import family268 from "./families/replicate~2Fresemble-ai~2Fchatterbox-turbo.json" with { type: "json" };
import family269 from "./families/replicate~2Frunwayml~2Fgen-4.5.json" with { type: "json" };
import family270 from "./families/replicate~2Fstability-ai~2Fstable-audio-2.5.json" with { type: "json" };
import family271 from "./families/requesty~2Fleanstral-1-5.json" with { type: "json" };
import family272 from "./families/requesty~2Fleanstral-1-5~40eu.json" with { type: "json" };
import family273 from "./families/requesty~2Fstep-3.7-flash.json" with { type: "json" };
import family274 from "./families/ring.json" with { type: "json" };
import family275 from "./families/sakana-namazu.json" with { type: "json" };
import family276 from "./families/seed.json" with { type: "json" };
import family278 from "./families/solar-mini.json" with { type: "json" };
import family279 from "./families/solar-pro.json" with { type: "json" };
import family277 from "./families/solar.json" with { type: "json" };
import family281 from "./families/sonar-deep-research.json" with { type: "json" };
import family282 from "./families/sonar-pro.json" with { type: "json" };
import family283 from "./families/sonar-reasoning.json" with { type: "json" };
import family280 from "./families/sonar.json" with { type: "json" };
import family284 from "./families/sora.json" with { type: "json" };
import family285 from "./families/stable-diffusion.json" with { type: "json" };
import family286 from "./families/step.json" with { type: "json" };
import family287 from "./families/text-embedding.json" with { type: "json" };
import family288 from "./families/the-grid-ai~2Fagent-max.json" with { type: "json" };
import family289 from "./families/the-grid-ai~2Fagent-prime.json" with { type: "json" };
import family290 from "./families/the-grid-ai~2Fagent-standard.json" with { type: "json" };
import family291 from "./families/the-grid-ai~2Fcode-max.json" with { type: "json" };
import family292 from "./families/the-grid-ai~2Fcode-prime.json" with { type: "json" };
import family293 from "./families/the-grid-ai~2Fcode-standard.json" with { type: "json" };
import family294 from "./families/the-grid-ai~2Ftext-max.json" with { type: "json" };
import family295 from "./families/the-grid-ai~2Ftext-prime.json" with { type: "json" };
import family296 from "./families/the-grid-ai~2Ftext-standard.json" with { type: "json" };
import family297 from "./families/titan-embed.json" with { type: "json" };
import family299 from "./families/together-ai~2Ftogethercomputer~2FRefuel-Llm-V2-Small.json" with { type: "json" };
import family298 from "./families/together-ai~2Ftogethercomputer~2FRefuel-Llm-V2.json" with { type: "json" };
import family301 from "./families/trinity-mini.json" with { type: "json" };
import family300 from "./families/trinity.json" with { type: "json" };
import family302 from "./families/unsloth.json" with { type: "json" };
import family303 from "./families/v0.json" with { type: "json" };
import family304 from "./families/veo.json" with { type: "json" };
import family305 from "./families/vercel~2Finception~2Fmercury-edit-2.json" with { type: "json" };
import family306 from "./families/vercel~2Finterfaze~2Finterfaze-beta.json" with { type: "json" };
import family307 from "./families/vercel~2Fopenai~2Fcodex-mini.json" with { type: "json" };
import family308 from "./families/vercel~2Fperplexity~2Fpplx-embed-v1-4b.json" with { type: "json" };
import family309 from "./families/vercel~2Fperplexity~2Fsonar-reasoning.json" with { type: "json" };
import family310 from "./families/vercel~2Fprime-intellect~2Fintellect-3.json" with { type: "json" };
import family311 from "./families/vercel~2Fsakana~2Fnamazu.json" with { type: "json" };
import family312 from "./families/vercel~2Fvercel~2Fv0-1.0-md.json" with { type: "json" };
import family313 from "./families/vercel~2Fvercel~2Fv0-1.5-md.json" with { type: "json" };
import family314 from "./families/voxtral.json" with { type: "json" };
import family315 from "./families/voyage.json" with { type: "json" };
import family316 from "./families/whisper.json" with { type: "json" };
import family317 from "./families/workers-ai~2F~40cf~2Fai4bharat~2Findictrans2-en-indic-1B.json" with { type: "json" };
import family318 from "./families/workers-ai~2F~40cf~2Fbaai~2Fbge-base-en-v1.5.json" with { type: "json" };
import family319 from "./families/workers-ai~2F~40cf~2Fbaai~2Fbge-large-en-v1.5.json" with { type: "json" };
import family320 from "./families/workers-ai~2F~40cf~2Fbaai~2Fbge-m3.json" with { type: "json" };
import family321 from "./families/workers-ai~2F~40cf~2Fbaai~2Fbge-reranker-base.json" with { type: "json" };
import family322 from "./families/workers-ai~2F~40cf~2Fbaai~2Fbge-small-en-v1.5.json" with { type: "json" };
import family323 from "./families/workers-ai~2F~40cf~2Fdeepgram~2Faura-1.json" with { type: "json" };
import family324 from "./families/workers-ai~2F~40cf~2Fdeepgram~2Faura-2-en.json" with { type: "json" };
import family325 from "./families/workers-ai~2F~40cf~2Fdeepgram~2Faura-2-es.json" with { type: "json" };
import family326 from "./families/workers-ai~2F~40cf~2Fhuggingface~2Fdistilbert-sst-2-int8.json" with { type: "json" };
import family327 from "./families/workers-ai~2F~40cf~2Fleonardo~2Flucid-origin.json" with { type: "json" };
import family328 from "./families/workers-ai~2F~40cf~2Fleonardo~2Fphoenix-1.0.json" with { type: "json" };
import family329 from "./families/workers-ai~2F~40cf~2Fllava-hf~2Fllava-1.5-7b-hf.json" with { type: "json" };
import family330 from "./families/workers-ai~2F~40cf~2Flykon~2Fdreamshaper-8-lcm.json" with { type: "json" };
import family331 from "./families/workers-ai~2F~40cf~2Fmeta~2Fm2m100-1.2b.json" with { type: "json" };
import family332 from "./families/workers-ai~2F~40cf~2Fmyshell-ai~2Fmelotts.json" with { type: "json" };
import family333 from "./families/workers-ai~2F~40cf~2Fpfnet~2Fplamo-embedding-1b.json" with { type: "json" };
import family334 from "./families/workers-ai~2F~40cf~2Fpipecat-ai~2Fsmart-turn-v2.json" with { type: "json" };
