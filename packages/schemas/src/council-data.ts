export { COUNCIL_APP_ID, councilMemberIds, councilMembers, defaultCouncilMemberIds };
export type { CouncilMemberDefinition, CouncilMemberId };

const COUNCIL_APP_ID = "council";
...
type CouncilMemberId = (typeof councilMemberIds)[number];
...
const defaultCouncilMemberIds = councilMemberIds;
