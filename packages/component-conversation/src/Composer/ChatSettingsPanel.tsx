        ...
        <div className="space-y-2">
          ...
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="advanced" className="space-y-3 px-1 pt-3">
              ...
              <details>
                ...
                <div className="mt-1 space-y-1 px-2 text-xs text-muted-foreground">
                  <p>
          ...
          <div className="flex justify-end border-t border-border px-1 pt-2">
            <Button
              ...
              className="h-8 rounded-md border border-border px-3 text-xs font-medium text-foreground hover:bg-selection"
            >
              Done
            </Button>
          </div>
