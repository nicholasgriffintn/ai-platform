...
import { prepareSandboxEnvironment } from "../../infrastructure/environment-setup";
...
import {
  startFileWatcher,
  type FileWatcher,
} from "../../infrastructure/feature-implementation/file-watcher";
import { resolvePromptStrategy } from "../../infrastructure/feature-implementation/prompt-strategy";
import { buildPlanningPrompt } from "../../infrastructure/feature-implementation/prompts";
import {
  deriveQualityGateCommands,
  runQualityGate,
} from "../../infrastructure/feature-implementation/quality-gate";
