...
async function requireSourceAccess(
	...
	if (!source) throw new AssistantError("Source not found", ErrorType.NOT_FOUND, 404);
...
export async function updateSource(
	...
	if (!updated) throw new AssistantError("Source not found", ErrorType.NOT_FOUND, 404);
