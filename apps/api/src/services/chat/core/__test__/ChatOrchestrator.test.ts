...
vi.mock("~/services/chat/validation/ValidationPipeline", () => ({
...
vi.mock("~/services/chat/preparation/RequestPreparer", () => ({
...
vi.mock("~/services/chat/streaming/responses", () => ({
  getAIResponse: mockGetAIResponse,
}));

vi.mock("~/services/chat/agent/provider-stream", () => ({
  consumeProviderStream: mockConsumeProviderStream,
}));

vi.mock("~/services/chat/tools/execution", () => ({
  handleToolCalls: mockHandleToolCalls,
}));

vi.mock("~/services/conversations/SessionManager", () => ({
