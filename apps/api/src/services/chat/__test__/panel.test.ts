...
import { extractPanelRouting, runPanel, type PanelMember } from "~/services/chat/panel";
...
vi.mock("~/services/chat/streaming/responses", () => ({ getAIResponse: mocks.getAIResponse }));
