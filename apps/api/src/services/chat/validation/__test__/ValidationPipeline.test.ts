...
vi.mock("~/services/chat/validation/validators/BasicInputValidator", () => ({
...
vi.mock("~/services/chat/validation/validators/AuthValidator", () => ({
  AuthValidator: class {
    constructor() {
...
vi.mock("~/services/chat/validation/validators/ModelConfigValidator", () => ({
...
vi.mock("~/services/chat/validation/validators/ContextLimitValidator", () => ({
...
vi.mock("~/services/chat/validation/validators/GuardrailsValidator", () => ({
