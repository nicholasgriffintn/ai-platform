...
import { messagesMatchStoredPrefix } from "~/services/chat/messages/comparison";
import {
  mergeStoredGoalMarkers,
  withoutGoalMarkerMessages,
} from "~/services/chat/messages/goal-marker-history";
import { hasSnapshotPart } from "~/services/chat/messages/parts";
import { buildUserMessageData } from "~/services/chat/policy/mode-metadata";
