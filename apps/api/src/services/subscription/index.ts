...
function assertStripeBillingAvailable(env: IEnv): void {
  if (!env.STRIPE_SECRET_KEY) {
    throw new AssistantError("Stripe billing is not configured", ErrorType.NOT_FOUND);
  }
}
...
export async function createBillingPortalSession(
  ...
  assertStripeBillingAvailable(env);
