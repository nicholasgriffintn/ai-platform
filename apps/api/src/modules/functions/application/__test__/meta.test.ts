...
vi.mock("~/modules/attention/application", () => ({
...
vi.mock("~/modules/teammates/application", () => ({
...
vi.mock("~/modules/teammates/application/access", () => ({
...
vi.mock("~/modules/search/application/global", () => ({
