...
import { getReplicatePredictionDetails } from "~/modules/apps/application/replicate/get-details";
import { listReplicatePredictions } from "~/modules/apps/application/replicate/list";
import {
