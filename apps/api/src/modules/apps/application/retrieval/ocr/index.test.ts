...
vi.mock("~/infrastructure/providers/capabilities/ocr", () => ({
...
vi.mock("~/modules/outputs/application/access", () => ({ requireConversationScope }));
vi.mock("~/modules/audit/application", () => ({ recordProjectAudit }));
