...
import type { StoredMachine } from "~/modules/machines/infrastructure/MachineRepository";
import { publishMachineEvent } from "~/modules/sync/application/conversation-events";
