...
vi.mock("~/modules/chat/application/policy/model-access", () => ({
...
vi.mock("~/modules/outputs/infrastructure/OutputRepository", () => ({
...
vi.mock("~/modules/user/infrastructure/UserRepository", () => ({
