...
vi.mock("~/modules/realtime/application/catalogue", () => ({
  listRealtimeLiveProviders: listRealtimeLiveProvidersMock,
}));

vi.mock("~/modules/realtime/application/proxy-grant", () => ({
