...
} from "@ngriffin_uk/polychat-utility-server/tool-names";

import { withExecutionRunContext } from "~/infrastructure/context/serviceContext";
...
export function buildToolRequestContext(params: {
  ...
  return {
    ...
    request: {
      ...
      teammate_context_id: chatOptions.teammate_context_id,
      delegation_context: chatOptions.delegation_context,
      resolved_configuration: chatOptions.resolved_configuration,
      mode,
      compute_site: chatOptions.compute_site,
