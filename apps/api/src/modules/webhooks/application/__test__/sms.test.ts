...
vi.mock("~/infrastructure/providers/capabilities/messaging/delivery", async (importOriginal) => {
  const original =
    await importOriginal<
      typeof import("~/infrastructure/providers/capabilities/messaging/delivery")
    >();
