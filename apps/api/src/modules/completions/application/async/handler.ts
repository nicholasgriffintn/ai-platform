...
import { getChatProvider, listChatProviders } from "~/infrastructure/providers/capabilities/chat";
...
function resolveHint(
  ...
  return metadata.contentHints?.[key as "placeholder" | "progress" | "failure"];
}
