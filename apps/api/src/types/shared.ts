...
export type IEnv = {
	...
	OURA_OAUTH_CLIENT_ID?: string;
	OURA_OAUTH_CLIENT_SECRET?: string;
	TODOIST_OAUTH_CLIENT_ID?: string;
	TODOIST_OAUTH_CLIENT_SECRET?: string;
	ASANA_OAUTH_CLIENT_ID?: string;
	ASANA_OAUTH_CLIENT_SECRET?: string;
	SENTRY_OAUTH_CLIENT_ID?: string;
	SENTRY_OAUTH_CLIENT_SECRET?: string;
	FITBIT_OAUTH_CLIENT_ID?: string;
	FITBIT_OAUTH_CLIENT_SECRET?: string;
	WITHINGS_OAUTH_CLIENT_ID?: string;
	WITHINGS_OAUTH_CLIENT_SECRET?: string;
	RAMP_OAUTH_CLIENT_ID?: string;
	RAMP_OAUTH_CLIENT_SECRET?: string;
