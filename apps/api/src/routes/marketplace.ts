...
const logger = createRouteLogger("MARKETPLACE");

app.use("/*", async (ctx, next) => {
  logger.info(
    `Processing marketplace route: ${ctx.req.method} ${ctx.req.path}`,
  );
  return next();
});
...
app.get(
  ...
  describeRoute({
    tags: ["marketplace"],
    summary: "Get shared agents from marketplace",
    description:
...
app.get(
  ...
  describeRoute({
    ...
    description: "Get a list of featured agents from the marketplace",
    responses: {
      "200": {
        description: "Success",
        content: {
...
app.get(
  ...
  describeRoute({
    tags: ["marketplace"],
    summary: "Get shared agent by ID",
...
app.post(
  ...
  describeRoute({
    ...
    description: "Share one of your agents to the marketplace",
    responses: {
      "200": {
        description: "Success",
        content: {
