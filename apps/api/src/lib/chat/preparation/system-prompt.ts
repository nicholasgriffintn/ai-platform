...
/**
 * Memory synthesis is personal, so a project-scoped turn never reads it.
 */
...
/**
 * Precedence: an explicit request prompt wins, then a system turn already in the
 * conversation, then a generated one. Project instructions and an active goal
 * contract are appended to whichever won, including the empty `no_system` case.
 */
