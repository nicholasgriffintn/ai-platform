...
export const workersAiModelConfig: ModelConfig = {
  ...
  "starling-lm-7b-beta": {
    ...
    matchingModel: "@hf/nexusflow/starling-lm-7b-beta",
    description:
      "Starling-LM-7B-beta is trained from Openchat-3.5-0106 with our new reward model Nexusflow/Starling-RM-34B and policy optimization method Fine-Tuning Language Models from Human Preferences (PPO).",
    provider: "workers-ai",
    type: ["text"],
    strengths: ["chat", "instruction"],
    contextWindow: 4096,
  ...
  "falcon-7b-instruct": {
    ...
    matchingModel: "@cf/tiiuae/falcon-7b-instruct",
    provider: "workers-ai",
    type: ["text"],
    strengths: ["chat", "instruction"],
    contextWindow: 4096,
