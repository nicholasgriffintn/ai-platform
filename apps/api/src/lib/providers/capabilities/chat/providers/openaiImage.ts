    ...
    switch (name) {
      case "prompt":
        if (typeof value === "string") {
          imageInput.prompt = value;
        }

        break;
      case "size":
        if (typeof value === "string") {
          imageInput.size = value;
        }
      ...
      case "quality":
        if (typeof value === "string") {
          imageInput.quality = value;
        }

        break;
      case "background":
        if (typeof value === "string") {
          imageInput.background = value;
        }

        break;
      case "moderation":
        if (typeof value === "string") {
          imageInput.moderation = value;
        }

        break;
      case "output_format":
        if (typeof value === "string") {
          imageInput.output_format = value;
        }

        break;
      case "output_compression":
        if (typeof value === "number") {
          imageInput.output_compression = value;
        }
