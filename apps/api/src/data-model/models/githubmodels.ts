...
export const githubModelsConfig: ModelConfig = {
	...
	"gpt-4-1-mini-gh": {
		...
		costPer1kInputTokens: 0,
		costPer1kOutputTokens: 0,
		strengths: ["coding", "analysis", "chat", "multilingual", "vision", "document", "tool_use"],
		contextComplexity: 3,
		reliability: 1,
		speed: 3,
		multimodal: true,
	...
	"gpt-4o-mini-gh": {
		...
		costPer1kInputTokens: 0,
		costPer1kOutputTokens: 0,
		strengths: ["chat", "analysis", "vision", "audio", "document", "tool_use"],
		contextComplexity: 3,
		reliability: 1,
		speed: 3,
		multimodal: true,
	...
	"gpt-4o-gh": {
		...
		costPer1kInputTokens: 0,
		costPer1kOutputTokens: 0,
		strengths: ["chat", "analysis", "vision", "audio", "coding", "document", "tool_use"],
		contextComplexity: 3,
		reliability: 1,
		speed: 4,
		multimodal: true,
	...
	"phi-4-multimodal-gh": {
		...
		costPer1kInputTokens: 0,
		costPer1kOutputTokens: 0,
		strengths: ["reasoning", "vision", "audio", "analysis", "tool_use"],
		contextComplexity: 3,
		reliability: 1,
		speed: 2,
		multimodal: true,
