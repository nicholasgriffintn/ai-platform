...
import family127 from "./families/llama.json";
...
import family251 from "./families/qwen.json";
import family252 from "./families/qwen3.5.json";
import family253 from "./families/qwen3.6.json";
import family254 from "./families/qwen3.7-max.json";
import family255 from "./families/qwen3.7-plus.json";
...
import provider11 from "./providers/groq.json";
import provider12 from "./providers/huggingface.json";
import provider13 from "./providers/openrouter.json";
import provider14 from "./providers/parallel.json";
import provider15 from "./providers/perplexity-ai.json";
import provider16 from "./providers/requesty.json";
import provider17 from "./providers/workers-ai.json";
import provider18 from "./providers/together-ai.json";
import provider19 from "./providers/google-ai-studio.json";
import provider20 from "./providers/elevenlabs.json";
import provider21 from "./providers/cartesia.json";
import provider22 from "./providers/fireworks.json";
import provider23 from "./providers/hyperbolic.json";
import provider24 from "./providers/inference.json";
import provider25 from "./providers/chutes.json";
import provider26 from "./providers/vercel.json";
import provider27 from "./providers/upstage.json";
import provider28 from "./providers/github-copilot.json";
import provider29 from "./providers/inception.json";
import provider30 from "./providers/v0.json";
import provider31 from "./providers/replicate.json";
import provider32 from "./providers/exa.json";
import provider33 from "./providers/fal.json";
import provider34 from "./providers/ideogram.json";
import provider35 from "./providers/cerebras.json";
import provider36 from "./providers/cohere.json";
import provider37 from "./providers/opencode.json";
import provider38 from "./providers/opencode-go.json";
import provider39 from "./providers/cortecs.json";
import provider40 from "./providers/nova.json";
import provider41 from "./providers/poolside.json";
import provider42 from "./providers/hetzner.json";
import provider43 from "./providers/alibaba.json";
import provider44 from "./providers/zai.json";
import provider45 from "./providers/moonshot.json";
...
import provider53 from "./providers/ovhcloud.json";
import provider54 from "./providers/regolo-ai.json";
import provider55 from "./providers/sakana.json";
import provider56 from "./providers/standardcompute.json";
import provider57 from "./providers/the-grid-ai.json";
import provider58 from "./providers/kimi-for-coding.json";
import provider59 from "./providers/thinkingmachines.json";
...
export default {
  families: {
    ...
    "hermes": family103,
    "huggingface/stepfun-ai/Step-3.5-Flash": family104,
    "huggingface/stepfun-ai/Step-3.7-Flash": family105,
    "hunyuan": family106,
    "Hy": family107,
    "hy3": family108,
    ...
    "ollama/ministral-3:14b": family173,
    "ollama/ministral-3:3b": family174,
    "ollama/ministral-3:8b": family175,
    "ollama/rnj-1:8b": family176,
    "olmo": family177,
    ...
    "openrouter/arcee-ai/maestro-reasoning": family188,
    "openrouter/arcee-ai/spotlight": family189,
    "openrouter/arcee-ai/trinity-large-preview": family190,
    "openrouter/arcee-ai/trinity-large-preview:free": family191,
    "openrouter/arcee-ai/trinity-large-thinking:free": family192,
    ...
    "openrouter/bytedance/ui-tars-1.5-7b": family201,
    "openrouter/dots-studio/dots-3-note-preview:free": family202,
    "openrouter/essentialai/rnj-1-instruct": family203,
    "openrouter/featherless/qwerky-72b": family204,
    "openrouter/gryphe/mythomax-l2-13b": family205,
    "openrouter/inflection/inflection-3-pi": family206,
    "openrouter/inflection/inflection-3-productivity": family207,
    "openrouter/kwaipilot/kat-coder-pro:free": family208,
    "openrouter/microsoft/mai-ds-r1:free": family209,
    "openrouter/microsoft/wizardlm-2-8x22b": family210,
    "openrouter/nex-agi/nex-n2-pro:free": family211,
    "openrouter/openrouter/bodybuilder": family212,
    "openrouter/openrouter/free": family213,
    "openrouter/openrouter/fusion": family214,
    "openrouter/openrouter/pareto-code": family215,
    "openrouter/openrouter/sherlock-dash-alpha": family216,
    "openrouter/openrouter/sherlock-think-alpha": family217,
    "openrouter/perceptron/perceptron-mk1": family218,
    "openrouter/poolside/laguna-xs.2": family219,
    "openrouter/poolside/laguna-xs.2:free": family220,
    "openrouter/prime-intellect/intellect-3": family221,
    "openrouter/relace/relace-apply-3": family222,
    "openrouter/relace/relace-search": family223,
    "openrouter/sao10k/l3-euryale-70b": family224,
    "openrouter/sarvamai/sarvam-m:free": family225,
    "openrouter/sourceful/riverflow-v2-fast-preview": family226,
    "openrouter/sourceful/riverflow-v2-max-preview": family227,
    "openrouter/sourceful/riverflow-v2-standard-preview": family228,
    "openrouter/stepfun/step-3.5-flash": family229,
    "openrouter/stepfun/step-3.5-flash:free": family230,
    "openrouter/stepfun/step-3.7-flash": family231,
    "openrouter/switchpoint/router": family232,
    "openrouter/thedrummer/cydonia-24b-v4.1": family233,
    "openrouter/thedrummer/rocinante-12b": family234,
    "openrouter/thedrummer/skyfall-36b-v2": family235,
    "openrouter/thedrummer/unslopnemo-12b": family236,
    "openrouter/tngtech/tng-r1t-chimera:free": family237,
    "openrouter/undi95/remm-slerp-l2-13b": family238,
    "openrouter/xiaomi/mimo-v2-flash": family239,
    "openrouter/xiaomi/mimo-v2-omni": family240,
    "openrouter/xiaomi/mimo-v2-pro": family241,
    "osmosis": family242,
    "palmyra": family243,
    "parallel/speed": family244,
    "perplexity-ai/r1-1776": family245,
    "perplexity-ai/sonar-deep-research": family246,
    "perplexity-ai/sonar-reasoning": family247,
    "phi": family248,
    "pixtral": family249,
    "qvq": family250,
    "qwen": family251,
    "qwen3.5": family252,
    "qwen3.6": family253,
    "qwen3.7-max": family254,
    "qwen3.7-plus": family255,
    "qwen3.8-max": family256,
    "recraft": family257,
    "rednote": family258,
    "regolo-ai/apertus-70b": family259,
    "regolo-ai/brick-complexity-pro": family260,
    "reka": family261,
    "replicate/5599ed30703defd1d160a25a63321b4dec97101d98b4674bcc56e41f62f35637": family262,
    "replicate/671ac645ce5e552cc63a54a2bbff63fcf798043055d2dac5fc9e36a837eedcfb": family263,
    "replicate/826801120720e563620006b99e412f7ed7b991dd4477e9160473d44a405ef9d9": family264,
    "replicate/847dfa8b01e739637fc76f480ede0c1d76408e1d694b830b5dfb8e547bf98405": family265,
    "replicate/alibaba/happyhorse-1.0": family266,
    ...
    "replicate/runwayml/gen-4.5": family276,
    "replicate/stability-ai/stable-audio-2.5": family277,
    "requesty/leanstral-1-5": family278,
    "requesty/leanstral-1-5@eu": family279,
    "requesty/step-3.7-flash": family280,
    "ring": family281,
    ...
    "step": family293,
    "text-embedding": family294,
    "the-grid-ai/agent-max": family295,
    "the-grid-ai/agent-prime": family296,
    "the-grid-ai/agent-standard": family297,
    "the-grid-ai/code-max": family298,
    "the-grid-ai/code-prime": family299,
    "the-grid-ai/code-standard": family300,
    "the-grid-ai/text-max": family301,
  ...
  providers: {
    ...
    "grok": provider10,
    "groq": provider11,
    "huggingface": provider12,
    "openrouter": provider13,
    "parallel": provider14,
    "perplexity-ai": provider15,
    "requesty": provider16,
    "workers-ai": provider17,
    "together-ai": provider18,
    "google-ai-studio": provider19,
    "elevenlabs": provider20,
    "cartesia": provider21,
    "fireworks": provider22,
    "hyperbolic": provider23,
    "inference": provider24,
    "chutes": provider25,
    "vercel": provider26,
    "upstage": provider27,
    "github-copilot": provider28,
    "inception": provider29,
    "v0": provider30,
    "replicate": provider31,
    "exa": provider32,
    "fal": provider33,
    "ideogram": provider34,
    "cerebras": provider35,
    ...
    "ovhcloud": provider53,
    "regolo-ai": provider54,
    "sakana": provider55,
    "standardcompute": provider56,
    "the-grid-ai": provider57,
    "kimi-for-coding": provider58,
    "thinkingmachines": provider59,
  },
};
