...
export const azureModelConfig: ModelConfig = createModelConfigObject([
  ...
  createModelConfig("microsoft/phi-4-multimodal", PROVIDER, {
    ...
    strengths: ["vision", "audio", "document"],
    contextComplexity: 3,
    reliability: 1,
    speed: 2,
    artificialAnalysis: {
  ...
  createModelConfig("claude-opus-4-8", PROVIDER, {
    ...
    knowledgeCutoffDate: "December 31, 2025",
  ...
  createModelConfig("gpt-chat-latest", PROVIDER, {
    name: "GPT Chat Latest",
    matchingModel: "gpt-chat-latest",
    status: "beta",
    openWeights: false,
    knowledgeCutoffDate: "December 1, 2025",
  ...
  createModelConfig("claude-mythos-5", PROVIDER, {
    name: "Claude Mythos 5",
    matchingModel: "claude-mythos-5",
