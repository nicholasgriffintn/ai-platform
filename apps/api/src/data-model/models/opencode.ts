...
export const opencodeModelConfig: ModelConfig = createModelConfigObject([
  ...
  createModelConfig("nemotron-3.5-lightning-free", PROVIDER, {
    ...
    matchingModel: "nemotron-3.5-lightning-free",
    family: "nemotron-free",
    openWeights: true,
  ...
  createModelConfig("muse-spark-1.2-contributor-free", PROVIDER, {
  	...
  	matchingModel: "muse-spark-1.2-contributor-free",
  	family: "muse-free",
  	openWeights: false,
  	releaseDate: "August 5, 2026",
  	lastUpdated: "August 5, 2026",
  ...
  createModelConfig("ling-3.0-flash-fin-free", PROVIDER, {
  	...
  	matchingModel: "ling-3.0-flash-fin-free",
  	family: "ling",
  	openWeights: false,
  ...
  createModelConfig("muse-spark-1.3-contributor-free", PROVIDER, {
  	name: "Muse Spark 1.3 Free",
  	matchingModel: "muse-spark-1.3-contributor-free",
  	family: "muse-free",
  	openWeights: false,
  	releaseDate: "September 2, 2026",
  	lastUpdated: "September 2, 2026",
  ...
  createModelConfig("deepseek-v4-flash-vision-exp", PROVIDER, {
  	name: "DeepSeek V4 Flash Vision Exp",
  	matchingModel: "deepseek-v4-flash-vision-exp",
  	family: "deepseek-flash",
  	openWeights: false,
  ...
  createModelConfig("muse-spark-1.3", PROVIDER, {
  	name: "Muse Spark 1.3",
  	matchingModel: "muse-spark-1.3",
  	family: "muse",
  	openWeights: false,
  	releaseDate: "September 2, 2026",
  	lastUpdated: "September 2, 2026",
