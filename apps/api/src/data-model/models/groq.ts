...
export const groqModelConfig: ModelConfig = {
  ...
  "groq/compound": {
    ...
    provider: "groq",
    deprecated: true,
    deprecationMessage: "Groq Compound is being retired. Use GPT OSS 120B instead.",
    replacementModel: "groq-openai-gpt-oss-120b",
  ...
  "groq/compound-mini": {
    ...
    provider: "groq",
    deprecated: true,
    deprecationMessage: "Groq Compound Mini is being retired. Use GPT OSS 20B instead.",
    replacementModel: "groq-openai-gpt-oss-20b",
    knowledgeCutoffDate: "September 4, 2025",
    releaseDate: "September 4, 2025",
    lastUpdated: "September 4, 2025",
    modalities: {
  ...
  "qwen/qwen3.8-27b": {
  	...
  	reasoningConfig: {
  		supportedEffortLevels: ["none", "default", "low", "medium", "high"],
  		defaultEffort: "none",
  	},
  },
};
