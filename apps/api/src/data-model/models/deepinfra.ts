...
export const deepinfraModelConfig: ModelConfig = createModelConfigObject([
  ...
  createModelConfig("google/gemma-4-E4B-it", PROVIDER, {
    name: "Gemma 4 E4B IT",
    matchingModel: "google/gemma-4-E4B-it",
    family: "gemma",
    openWeights: true,
    releaseDate: "April 2, 2026",
    lastUpdated: "April 2, 2026",
  ...
  createModelConfig("stepfun-ai/Step-3.7-Flash", PROVIDER, {
    name: "Step 3.7 Flash",
  ...
  createModelConfig("deepseek-ai/DeepSeek-V3.1", PROVIDER, {
    name: "DeepSeek-V3.1",
  ...
  createModelConfig("ByteDance/Seed-2.0-mini", PROVIDER, {
    name: "Seed 2.0 Mini",
    matchingModel: "ByteDance/Seed-2.0-mini",
    family: "seed",
    openWeights: false,
    releaseDate: "February 14, 2026",
    lastUpdated: "February 14, 2026",
  ...
  createModelConfig("ByteDance/Seed-2.0-pro", PROVIDER, {
    name: "Seed 2.0 Pro",
    matchingModel: "ByteDance/Seed-2.0-pro",
    family: "seed",
    openWeights: false,
    releaseDate: "February 14, 2026",
    lastUpdated: "February 14, 2026",
  ...
  createModelConfig("Qwen/Qwen3.8-27B", PROVIDER, {
    name: "Qwen3.8 27B",
  ...
  createModelConfig("zai-org/GLM-5.3-Flash", PROVIDER, {
  	name: "GLM-5.3-Flash",
  	matchingModel: "zai-org/GLM-5.3-Flash",
  	family: "glm",
  	openWeights: false,
  ...
  createModelConfig("deepseek-ai/DeepSeek-V4-Flash-Vision-Exp", PROVIDER, {
  	name: "DeepSeek V4 Flash Vision Exp",
  	matchingModel: "deepseek-ai/DeepSeek-V4-Flash-Vision-Exp",
  	family: "deepseek-flash",
  	openWeights: false,
