...
export const chutesModelConfig: ModelConfig = createModelConfigObject([
	...
	createModelConfig("Qwen/Qwen3-Coder-Next-TEE", PROVIDER, {
		...
		matchingModel: "Qwen/Qwen3-Coder-Next-TEE",
	...
	createModelConfig("tngtech/DeepSeek-TNG-R1T2-Chimera-TEE", PROVIDER, {
		...
		matchingModel: "tngtech/DeepSeek-TNG-R1T2-Chimera-TEE",
		releaseDate: "April 25, 2026",
		lastUpdated: "April 25, 2026",
		modalities: {
			input: ["text"],
	...
	createModelConfig("unsloth/Llama-3.2-3B-Instruct", PROVIDER, {
		...
		matchingModel: "unsloth/Llama-3.2-3B-Instruct",
	...
	createModelConfig("zai-org/GLM-5-Turbo", PROVIDER, {
		name: "GLM 5 Turbo",
		matchingModel: "zai-org/GLM-5-Turbo",
	...
	createModelConfig("Qwen/Qwen3-235B-A22B-Thinking-2507-TEE", PROVIDER, {
		name: "Qwen3 235B A22B Thinking 2507 TEE",
		matchingModel: "Qwen/Qwen3-235B-A22B-Thinking-2507-TEE",
		family: "qwen",
		openWeights: true,
		knowledgeCutoffDate: "April 2025",
	...
	createModelConfig("unsloth/Mistral-Nemo-Instruct-2407-TEE", PROVIDER, {
		name: "Mistral Nemo Instruct 2407 TEE",
		matchingModel: "unsloth/Mistral-Nemo-Instruct-2407-TEE",
		family: "mistral-nemo",
		openWeights: true,
		knowledgeCutoffDate: "July 2024",
	...
	createModelConfig("zai-org/GLM-5.2-TEE", PROVIDER, {
		name: "GLM 5.2 TEE",
		matchingModel: "zai-org/GLM-5.2-TEE",
		family: "glm",
		openWeights: true,
	...
	createModelConfig("deepseek-ai/DeepSeek-V4-Flash-0731-TEE", PROVIDER, {
		name: "DeepSeek V4 Flash 0731 TEE",
		matchingModel: "deepseek-ai/DeepSeek-V4-Flash-0731-TEE",
