...
export const replicateModelConfig: ModelConfig = createModelConfigObject([
	...
	createModelConfig("replicate-flux-2-max", PROVIDER, {
		...
		strengths: ["creative", "vision", "image"],
		supportsStreaming: false,
		supportsAttachments: false,
		costPerRun: 0.04,
		modalities: {
	...
	createModelConfig("replicate-sd3.5large", PROVIDER, {
		...
		strengths: ["creative", "vision", "document", "image"],
		supportsStreaming: false,
	...
	createModelConfig("replicate-google-nano-banana-2", PROVIDER, {
		name: "Google Nano Banana 2",
		matchingModel: "google/nano-banana-2",
		description:
			"Google image generation and editing model with higher resolution output and optional search grounding.",
		strengths: ["creative", "vision", "image"],
		supportsStreaming: false,
		supportsAttachments: false,
		costPerRun: 0.039,
		...
		inputSchema: {
			reference: "https://replicate.com/google/nano-banana-2",
			fields: [
				{
					name: "prompt",
					type: "string",
	...
	createModelConfig("replicate-xai-grok-imagine-image", PROVIDER, {
		name: "Grok Imagine Image",
		matchingModel: "xai/grok-imagine-image",
		description: "Generate and edit images using xAI's Grok Imagine Image model.",
		strengths: ["creative", "vision", "image"],
		supportsStreaming: false,
		supportsAttachments: false,
		modalities: {
		...
		inputSchema: {
			reference: "https://replicate.com/xai/grok-imagine-image",
			fields: [
				{
					name: "prompt",
					type: "string",
