...
export const opencodeGoModelConfig: ModelConfig = createModelConfigObject([
  ...
  createModelConfig("hy4-preview", PROVIDER, {
  	name: "Hy4 preview",
  	matchingModel: "hy4-preview",
  	family: "Hy",
  	openWeights: true,
  ...
  createModelConfig("muse-spark-1.3-contributor", PROVIDER, {
  	name: "Muse Spark 1.3 Contributor",
  	matchingModel: "muse-spark-1.3-contributor",
  	family: "muse",
  	openWeights: false,
