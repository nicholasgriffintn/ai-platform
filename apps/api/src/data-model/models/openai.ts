...
const openaiLongContextPricing = {
...
const openaiPromptCacheOptions = {
...
export const openaiModelConfig: ModelConfig = createModelConfigObject([
  ...
  createModelConfig("gpt-4.1", PROVIDER, {
    ...
    costPer1kInputTokens: 0.002,
    costPer1kCachedInputTokens: 0.0005,
    costPer1kOutputTokens: 0.008,
  ...
  createModelConfig("gpt-4.1-mini", PROVIDER, {
    ...
    strengths: ["coding", "academic", "instruction", "vision", "document", "tool_use"],
    contextComplexity: 4,
    reliability: 1,
    speed: 3,
    multimodal: true,
  ...
  createModelConfig("gpt-5", PROVIDER, {
    ...
    costPer1kCachedInputTokens: 0.000125,
    costPer1kOutputTokens: 0.01,
    supportsTopP: false,
    strengths: [
      "coding",
  ...
  createModelConfig("gpt-5-nano", PROVIDER, {
    ...
    supportsTopP: false,
    strengths: ["coding", "chat", "general_knowledge", "vision", "document", "tool_use"],
    contextComplexity: 4,
    reliability: 1,
    speed: 3,
    multimodal: true,
  ...
  createModelConfig("gpt-5.2", PROVIDER, {
    ...
    costPer1kCachedInputTokens: 0.000175,
    costPer1kOutputTokens: 0.014,
    samplingSupportedReasoningEfforts: ["none"],
    strengths: [
      "coding",
      "reasoning",
      "analysis",
  ...
  createModelConfig("gpt-5.1-codex", PROVIDER, {
    ...
    deprecated: true,
    strengths: ["coding", "reasoning", "analysis", "vision", "document", "tool_use"],
    supportsAttachments: true,
    supportsTemperature: false,
  ...
  createModelConfig("gpt-5.4", PROVIDER, {
    ...
    maxTokens: 128000,
    costPer1kInputTokens: 0.0025,
    costPer1kCachedInputTokens: 0.00025,
    costPer1kOutputTokens: 0.015,
    longContextPricing: openaiLongContextPricing,
    strengths: [
      "coding",
      "reasoning",
      "analysis",
  ...
  createModelConfig("gpt-5.4-mini", PROVIDER, {
    ...
    costPer1kCachedInputTokens: 0.000075,
  ...
  createModelConfig("gpt-5.4-nano", PROVIDER, {
    ...
    costPer1kCachedInputTokens: 0.00002,
  ...
  createModelConfig("gpt-5.5", PROVIDER, {
    ...
    supportsAttachments: true,
    supportsTemperature: false,
    prefersResponsesApiForReasoning: true,
    supportsPromptCaching: true,
    supportsToolCalls: true,
    ...openaiResponsesHostedTools,
    ...openaiHostedShellTools,
  ...
  createModelConfig("gpt-5.5-pro", PROVIDER, {
    ...
    maxTokens: 128000,
    costPer1kInputTokens: 0.03,
    costPer1kCachedInputTokens: 0.003,
    costPer1kOutputTokens: 0.18,
    longContextPricing: openaiLongContextPricing,
    strengths: [
      "reasoning",
  ...
  createModelConfig("gpt-realtime-mini", PROVIDER, {
    ...
    strengths: ["audio", "chat", "vision", "document", "tool_use"],
    contextComplexity: 3,
    reliability: 5,
    speed: 5,
    multimodal: true,
  ...
  createModelConfig("gpt-5.6", PROVIDER, {
    ...
    maxTokens: 128000,
    costPer1kInputTokens: 0.004,
    costPer1kCachedInputTokens: 0.0004,
    costPer1kCacheWriteTokens: 0.005,
    costPer1kOutputTokens: 0.02,
    longContextPricing: openaiLongContextPricing,
    ...openaiFlexibleServiceTiers,
    reasoningConfig: {
  ...
  createModelConfig("gpt-5.6-luna", PROVIDER, {
    ...
    costPer1kInputTokens: 0.0002,
    costPer1kCachedInputTokens: 0.00002,
    costPer1kCacheWriteTokens: 0.00025,
  ...
  createModelConfig("gpt-5.6-terra", PROVIDER, {
    ...
    maxTokens: 128000,
    costPer1kInputTokens: 0.002,
    costPer1kCachedInputTokens: 0.0002,
    costPer1kCacheWriteTokens: 0.0025,
  ...
  createModelConfig("gpt-6-astra", PROVIDER, {
    name: "GPT-6 Astra",
    ...
    family: "gpt-astra",
    openWeights: false,
    knowledgeCutoffDate: "April 30, 2026",
    ...
    supportsToolCalls: true,
    supportsAsyncToolCalls: true,
    supportsReasoningConfigurationUpdates: true,
    ...openaiPromptCacheOptions,
    ...openaiResponsesHostedTools,
    ...openaiHostedShellTools,
    ...openaiToolSearchTool,
  ...
  createModelConfig("gpt-realtime-2.1", PROVIDER, {
    ...
    matchingModel: "gpt-realtime-2.1",
    family: "gpt",
    openWeights: false,
    knowledgeCutoffDate: "September 30, 2024",
