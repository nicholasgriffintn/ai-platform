...
export const requestyModelConfig: ModelConfig = createModelConfigObject([
  ...
  createModelConfig("claude-fable-5.1", PROVIDER, {
  ...
  createModelConfig("claude-fable-5.1@eu", PROVIDER, {
  	name: "Claude Fable 5.1 (EU)",
  	matchingModel: "claude-fable-5.1@eu",
  	family: "claude-fable",
  	openWeights: false,
  	knowledgeCutoffDate: "June 2026",
  	releaseDate: "September 1, 2026",
  ...
  createModelConfig("deepseek-v4-pro-0813@eu", PROVIDER, {
  	name: "DeepSeek V4 Pro 0813 (EU)",
  	matchingModel: "deepseek-v4-pro-0813@eu",
  	family: "deepseek-thinking",
  	openWeights: true,
  	releaseDate: "August 12, 2026",
  ...
  createModelConfig("gemini-2.5-flash-lite@eu", PROVIDER, {
  	name: "Gemini 2.5 Flash-Lite (EU)",
  	matchingModel: "gemini-2.5-flash-lite@eu",
  	family: "gemini-flash-lite",
  	openWeights: false,
  	knowledgeCutoffDate: "January 2025",
  	releaseDate: "June 17, 2025",
  ...
  createModelConfig("gemini-2.5-pro@eu", PROVIDER, {
  	name: "Gemini 2.5 Pro (EU)",
  	matchingModel: "gemini-2.5-pro@eu",
  	family: "gemini-pro",
  	openWeights: false,
  	knowledgeCutoffDate: "January 2025",
  	releaseDate: "June 17, 2025",
  ...
  createModelConfig("gemini-3.8-flash@eu", PROVIDER, {
  	name: "Gemini 3.8 Flash (EU)",
  	matchingModel: "gemini-3.8-flash@eu",
  	family: "gemini-flash",
  	openWeights: false,
  	releaseDate: "September 2, 2026",
  	lastUpdated: "September 2, 2026",
  ...
  createModelConfig("qwen3.8-2.4T-A95B@eu", PROVIDER, {
  	name: "Qwen3.8 2.4T A95B (EU)",
  	matchingModel: "qwen3.8-2.4T-A95B@eu",
  	family: "qwen",
  	openWeights: true,
  	releaseDate: "August 12, 2026",
  	lastUpdated: "August 12, 2026",
  ...
  createModelConfig("qwen3.8-flash-next", PROVIDER, {
  	name: "Qwen3.8 Flash Next",
  	matchingModel: "qwen3.8-flash-next",
  	family: "qwen",
  	openWeights: true,
  ...
  createModelConfig("qwen3.8-flash-next@eu", PROVIDER, {
  	name: "Qwen3.8 Flash Next (EU)",
  	matchingModel: "qwen3.8-flash-next@eu",
  	family: "qwen",
  	openWeights: true,
  	releaseDate: "August 27, 2026",
  	lastUpdated: "August 27, 2026",
