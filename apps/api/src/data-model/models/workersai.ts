...
export const workersAiModelConfig: ModelConfig = {
  ...
  "@cf/zai-org/glm-4.7-flash": {
    ...
    strengths: ["chat", "instruction", "analysis", "multilingual", "coding", "tool_use"],
    contextComplexity: 4,
    reliability: 1,
    speed: 4,
    supportsResponseFormat: true,
  ...
  "@cf/moonshotai/kimi-k2.7-code": {
    ...
    costPer1kInputTokens: 0.00095,
    costPer1kOutputTokens: 0.004,
    strengths: ["coding", "reasoning", "analysis", "agents", "vision", "document", "tool_use"],
    contextComplexity: 4,
    reliability: 2,
    speed: 3,
    reasoningConfig: {
  ...
  "@cf/deepseek-ai/deepseek-v4-flash-0731": {
    ...
    matchingModel: "@cf/deepseek-ai/deepseek-v4-flash-0731",
    provider: "workers-ai",
  ...
  "@cf/qwen/qwen3.8-27b": {
    name: "Qwen3.8 27B",
    matchingModel: "@cf/qwen/qwen3.8-27b",
    provider: "workers-ai",
    family: "qwen",
    openWeights: true,
