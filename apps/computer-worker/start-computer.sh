...
"$CHROME_BIN" --no-sandbox --disable-dev-shm-usage --disable-gpu --no-first-run --no-default-browser-check --user-data-dir=/workspace/profile about:blank > /tmp/computer/chromium.log 2>&1 &
