		...
		>
			<Prose>
				...
				<p>
					...
					you access or use our AI chatbot services ("Service"). We are
				...
				<ul>
					...
					<li>
						...
						well as within our logs for as long as is permitted by law.
					</li>
				</ul>
				...
				<p>
					...
					operating our Service, conducting business, or servicing you, provided
				...
				<p>
					...
					are under 18, you may only use the service with the involvement and
