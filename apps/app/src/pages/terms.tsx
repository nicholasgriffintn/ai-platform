...
import { APP_NAME, CONTACT_LINK, JURISDICTION, TERMS_EFFECTIVE_DATE } from "~/constants";
	...
	return (
		<PageShell title="Terms of Service" sidebarContent={<StandardSidebarContent />}>
			<Prose>
				...
				<p>
					Welcome to {APP_NAME} ("Service"). By accessing or using our AI chatbot services, you
				...
				<p>
					{APP_NAME} provides AI-powered conversational services. You agree to use these services
					only for lawful purposes and in a manner that does not violate the rights of, or restrict
					or inhibit the use and enjoyment of, the Service by any third party.
				</p>
				<h3>2.1 Age Requirements</h3>
				<p>
					You must be at least 18 years of age to use our services without permission. By using our
					services you represent that you are above the minimum age required by the laws of your
					country. If you are under the age of 18, you represent that you have your parent or
					guardian's permission to use the Service and they have read and agreed to these Terms on
					your behalf.
				</p>
				<h3>2.2 Service Description</h3>
				<p>
					{APP_NAME} is an AI-powered chatbot that allows users to interact with artificial
				...
				<ul>
					<li>
						Using the Service for any illegal purpose or in violation of any local, state, national,
						or international law
					</li>
					<li>
						Transmitting any material that is harmful, threatening, abusive, harassing, defamatory,
						obscene, or otherwise objectionable
					</li>
					<li>
						Attempting to interfere with, compromise the system integrity or security, or circumvent
						any technical measures of the Service
					</li>
					<li>
						Engaging in any automated use of the system, such as using scripts to collect
						information or interact with the Service
					</li>
				...
				<p>
					...
					design, text, graphics, interfaces, and code, are owned by {APP_NAME} or its licensors and
					are protected by copyright, trademark, and other intellectual property laws.
				</p>
				<h3>5.1 User Content License</h3>
				<p>
					By submitting or transmitting any content ("User Content") to {APP_NAME}, you grant us a
					non-exclusive, worldwide, royalty-free, sublicensable, and transferable license to store,
					display, process, and use your User Content in connection with providing and improving the
					Service.
				</p>
				<h3>5.2 Trademarks</h3>
				<p>
					All trademarks, service marks, logos, trade names, and any other proprietary designations
					belonging to {APP_NAME} used herein are our trademarks. Nothing in these Terms gives you
					the right to use any of our trademarks, logos, or brand elements.
				</p>

				<h2>6. Limitation of Liability</h2>
				<p>
					To the maximum extent permitted by law, {APP_NAME} shall not be liable for any indirect,
					incidental, special, consequential, or punitive damages resulting from your access to or
				...
				<p>
					Upon termination, your rights to use our Service will immediately cease, and you must
					discontinue all use of the Service.
				</p>

				<h2>8. Changes to Terms</h2>
				<p>
					We may modify these Terms at any time at our sole discretion. If we make changes, we will
					provide notice by posting the updated Terms on our website. Your continued use of the
				...
				<p>
					...
					expressed or implied, regarding the operation or availability of the Service. The
					information provided is for general informational purposes only and should not be relied
					upon for making decisions of any kind.
				</p>

				<h2>12. Indemnification</h2>
				<p>
					You agree to defend, indemnify, and hold harmless {APP_NAME} and its affiliates, officers,
					directors, employees, and agents, from and against all claims, damages, liabilities,
