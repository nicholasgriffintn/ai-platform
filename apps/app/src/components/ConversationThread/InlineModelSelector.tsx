...
export const InlineModelSelector = ({
  ...
  const currentModel = selectedModel ? availableModels[selectedModel] : null;
            ...
            {currentModel && (
              <>
                ...
                <button
                  ...
                  className="w-full text-left px-2 py-1.5 rounded text-sm flex items-center gap-2 transition-colors bg-blue-50 dark:bg-blue-900/20 hover:bg-blue-100 dark:hover:bg-blue-900/30"
                >
                  <ModelIcon
            ...
            {Object.values(featuredModels)
              ...
              .map((model) => (
                <button
                  ...
                  className="w-full text-left px-2 py-1.5 rounded text-sm flex items-center gap-2 transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-800/50"
                >
                  <ModelIcon
