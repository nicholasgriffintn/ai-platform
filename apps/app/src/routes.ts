...
export default [
  ...
  route("/apps/video-notes", "pages/apps/video-notes/index.tsx"),
  route("/apps/video-notes/new", "pages/apps/video-notes/new.tsx"),
  route("/apps/video-notes/:id", "pages/apps/video-notes/[id].tsx"),
