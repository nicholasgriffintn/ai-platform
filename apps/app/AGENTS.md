...
export const exampleService = {
   ...
   */
  async update(id: string, request: Partial<ExampleRequest>): Promise<ExampleResponse> {
    return fetchWrapper(`${API_BASE_URL}/examples/${id}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(request),
 ...
 */
export function Example({ data, onAction, disabled = false, className = "" }: ExampleProps) {
